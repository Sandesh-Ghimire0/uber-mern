...
function FinishRide({setShowFinishRide}) {
    return (
        <div>
            <div>
                <div className="flex justify-between">
                    ...
                    <div onClick={() => setShowFinishRide(false)}>
                ...
                <div className="">
                    <div className="flex gap-3">
                        <Link to='/captain-home' className="px-4 py-2 flex justify-center items-center text-white bg-green-600 rounded-md w-full">
                            Finish Ride
                        </Link>
                    </div>
                </div>
